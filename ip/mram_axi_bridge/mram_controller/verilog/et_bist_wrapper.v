module et_bist_wrapper #(
    ...
    input        [ADD_WIDTH-4:0]    reg_add,
    input        [DATA_WIDTH-1:0]   reg_din,
    input                           data_inv,

    //output  reg                   bist_ce_b,
    output  reg  [7:0]              bist_ce,
    output  reg  [7:0]              bist_dout_en,
    output  reg                     bist_we,
    ...
    output  reg  [ADD_WIDTH-4:0]    bist_add,
    ...
    assign mkBist_cfg_regs.rh2_offset = rh2_offset;
    ...
    mkEtBist et_bist_u(
        .CLK(clk),
        .mram_clk_en_o(mkBist_clk_en),
        .RST_B(rst_b & bist_rst_b),
        .mram_rdata_i(mram_dout),
        .mram_busy_i(busy),
        .mram_ce_o(mkBist_ce),
        .mram_addr_o(mkBist_add),
        .mram_dout_en_o(mkBist_dout_en),
        .mram_din_o(mkBist_din),
        .mram_we_o(mkBist_we),
        .mram_ref_prg_en_o(mkBist_ref_prg_en),
        .mram_bwe_o(),
        .rom_addr(rom_add),
        .rom_ce(rom_ce),
        .rom_dout_i(rom_data),
