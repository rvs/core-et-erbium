...
read_sverilog -container r -libname WORK { /scratch/argon/mjaggers/git/argon-hdl/controller/verilog/bist_rte.sv }
set_top ctrl_rte
read_verilog -container i -libname WORK -05 { /scratch/argon/mjaggers/git/argon-hdl/controller/synth/bist_rte_syn.v }
