...
analyze -format verilog -library WORK {../verilog/bist_write.v}
elaborate bist_write -library WORK -update
#link
create_clock "clk" -period 12  -waveform {0.0 6.0}
...
write -hierarchy -format verilog -output bist_write_syn.v
report_area
