...
analyze -format sverilog -library WORK {../verilog/test_regs.v}
elaborate test_regs -library WORK -update
#link
create_clock "PCLK" -period 3  -waveform {0.0 1.5}
...
write -hierarchy -format verilog -output test_regs_syn.v
report_area
