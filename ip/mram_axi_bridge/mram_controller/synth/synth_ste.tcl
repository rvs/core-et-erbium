...
analyze -format sverilog -library WORK {../verilog/ste.sv}
elaborate ste -library WORK -update
#link
create_clock "sa_cal_clk_i" -period 3  -waveform {0.0 1.5}
...
write -hierarchy -format verilog -output ste_syn.v
report_area
