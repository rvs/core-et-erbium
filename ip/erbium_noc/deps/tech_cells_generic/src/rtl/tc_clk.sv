...
module erbium_noc_tc_clk_buffer (
  input  logic clk_i,
  output logic clk_o
);
...
module erbium_noc_tc_clk_gating #(
...
module erbium_noc_tc_clk_inverter (
  input  logic clk_i,
  output logic clk_o
);
...
`ifndef SYNTHESIS
module erbium_noc_tc_clk_delay #(
