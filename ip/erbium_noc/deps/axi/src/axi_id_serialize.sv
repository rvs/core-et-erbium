...
module erbium_noc_axi_id_serialize #(
  ...
  parameter int unsigned IdMap [erbium_noc_axi_pkg::iomsb(IdMapNumEntries):0][0:1] = '{default: {32'b0, 32'b0}}
) (
  ...
  localparam int unsigned SelectWidth = erbium_noc_cf_math_pkg::idx_width(AxiMstPortMaxUniqIds);
...
module erbium_noc_axi_id_serialize_intf #(
