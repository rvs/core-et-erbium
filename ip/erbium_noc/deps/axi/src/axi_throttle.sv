...
module erbium_noc_axi_throttle #(
    ...
    parameter int unsigned WCntWidth = erbium_noc_cf_math_pkg::idx_width(MaxNumAwPending),
    /// The width of the read credit counter (*DO NOT OVERWRITE*)
    parameter int unsigned RCntWidth = erbium_noc_cf_math_pkg::idx_width(MaxNumArPending),
...
endmodule : erbium_noc_axi_throttle
