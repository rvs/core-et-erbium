...
module erbium_noc_axi_burst_splitter_gran #(
  ...
  // length
  input  erbium_noc_axi_pkg::len_t len_limit_i,
  ...
  function bit txn_supported(erbium_noc_axi_pkg::atop_t atop, erbium_noc_axi_pkg::burst_t burst, erbium_noc_axi_pkg::cache_t cache,
      erbium_noc_axi_pkg::len_t len, erbium_noc_axi_pkg::len_t len_limit);
    ...
    //
      ...
      if (burst == erbium_noc_axi_pkg::BURST_WRAP) return 1'b0;

      // ATOP bursts are not supported.
      if (atop != '0 & len > 0) return 1'b0;

      // The AXI Spec (A3.4.1) only allows splitting non-modifiable transactions ..
      if (!erbium_noc_axi_pkg::modifiable(cache)) begin
        // .. if they are INCR bursts and longer than 16 beats.
        return (burst == erbium_noc_axi_pkg::BURST_INCR) & (len > 16);
      end
  ...
  erbium_noc_axi_pkg::len_t  w_cnt_len;
  erbium_noc_axi_burst_splitter_gran_ax_chan #(
  ...
  erbium_noc_axi_pkg::len_t w_len_d, w_len_q;
        ...
        if (mst_resp_i.b_valid) begin
          ...
          if (w_cnt_gnt) begin
            if (w_cnt_len < ({1'b0, len_limit_i} + 9'h001)) begin
              ...
              if (w_cnt_err) begin
                act_resp.b.resp = erbium_noc_axi_pkg::RESP_SLVERR;
              end
  ...
  erbium_noc_axi_pkg::len_t  r_cnt_len;
  erbium_noc_axi_burst_splitter_gran_ax_chan #(
...
module erbium_noc_axi_burst_splitter_gran_ax_chan #(
  ...
  input  id_t           cnt_id_i,
  output erbium_noc_axi_pkg::len_t cnt_len_o,
  ...
  typedef logic[erbium_noc_axi_pkg::LenWidth:0] num_beats_t;
  ...
  erbium_noc_axi_burst_splitter_gran_counters #(
    .MaxTxns ( MaxTxns  ),
    .IdWidth ( IdWidth  ),
    .CutPath ( CutPath  ),
    .FullBW  ( FullBW   )
    ...
    unique case (state_q)
        ...
        if (ax_valid_i && cnt_alloc_gnt) begin
          ...
          // Splitting required.
            ...
            if (ax_ready_i) begin
              ...
              if (ax_d.burst == erbium_noc_axi_pkg::BURST_INCR) begin
                // Align
                ax_d.addr = erbium_noc_axi_pkg::aligned_addr(erbium_noc_axi_pkg::largest_addr_t'(ax_d.addr), ax_d.size);
                // modify the address
      ...
      Busy: begin
        ...
        if (num_beats_q <= max_beats) begin
          ...
          ax_o.len = erbium_noc_axi_pkg::len_t'(num_beats_q - 9'h001);
        end else begin
          ax_o.len = len_limit_i;
        end
        // next state
        if (ax_ready_i) begin
          if (num_beats_q <= max_beats) begin
            ...
            if (ax_q.burst == erbium_noc_axi_pkg::BURST_INCR) begin
              ax_d.addr = erbium_noc_axi_pkg::aligned_addr(erbium_noc_axi_pkg::largest_addr_t'(ax_q.addr), ax_q.size);
...
/// transactions.
module erbium_noc_axi_burst_splitter_gran_counters #(
  parameter int unsigned MaxTxns = 32'd0,
  parameter int unsigned IdWidth = 32'd0,
  parameter bit          CutPath =  1'b0,
  parameter bit          FullBW  =  1'b0,
  parameter type         id_t    = logic [IdWidth-1:0],
  parameter type         cnt_t   = logic [erbium_noc_axi_pkg::LenWidth:0]
) (
  input  logic          clk_i,
  input  logic          rst_ni,

  input  id_t           alloc_id_i,
  input  erbium_noc_axi_pkg::len_t alloc_len_i,
