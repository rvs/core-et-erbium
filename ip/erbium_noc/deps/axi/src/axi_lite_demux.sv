...
module erbium_noc_axi_lite_demux #(
...
module erbium_noc_axi_lite_demux_intf #(
  ...
  erbium_noc_AXI_LITE.Slave   slv,                 // slave port
  erbium_noc_AXI_LITE.Master  mst [NoMstPorts-1:0] // master ports
);
