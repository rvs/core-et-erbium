...
#(
  ...
  input  logic                       rst_ni,
  input  logic                       test_en_i,
  erbium_noc_AXI_BUS.Slave                      slv_ports [NumSlvPorts-1:0],
  erbium_noc_AXI_BUS.Master                     mst_ports [NumMstPorts-1:0],
  input  rule_t  [NumAddrRules-1:0]  addr_map_i
);
