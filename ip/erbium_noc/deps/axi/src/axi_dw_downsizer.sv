...
module erbium_noc_axi_dw_downsizer #(
   ...
   *  DEFINITIONS  *
   *****************/
  import erbium_noc_axi_pkg::aligned_addr;
  import erbium_noc_axi_pkg::modifiable  ;

  import erbium_noc_cf_math_pkg::idx_width;
  ...
  erbium_noc_axi_err_slv #(
    .AxiIdWidth(AxiIdWidth          ),
    .Resp      (erbium_noc_axi_pkg::RESP_SLVERR),
  ...
  typedef struct packed {
    ...
    erbium_noc_axi_pkg::size_t orig_ar_size;
    logic injected_aw           ;
  } r_req_t;
  ...
  typedef struct packed {
    ...
    burst_len_t burst_len         ;
    erbium_noc_axi_pkg::len_t orig_aw_len    ;
    erbium_noc_axi_pkg::burst_t orig_aw_burst;
    erbium_noc_axi_pkg::resp_t burst_resp    ;
    erbium_noc_axi_pkg::size_t orig_aw_size  ;
  } w_req_t;
        ...
        R_IDLE : begin
          ...
          if (arb_slv_ar_req && (idx_ar_downsizer == t)) begin
            ...
            if (inject_aw_into_ar) begin
              ...
              r_req_d.r.resp       = erbium_noc_axi_pkg::RESP_EXOKAY;

              case (r_req_d.ar.burst)
                erbium_noc_axi_pkg::BURST_INCR : begin
                ...
                erbium_noc_axi_pkg::BURST_FIXED: begin
                  // Single transaction
                  if (r_req_d.ar.len == '0) begin
                    ...
                    if (conv_ratio != 1) begin
                      ...
                      r_req_d.ar.len   = r_req_d.burst_len  ;
                      r_req_d.ar.size  = AxiMstPortMaxSize  ;
                      r_req_d.ar.burst = erbium_noc_axi_pkg::BURST_INCR;
                    end
                  end else begin
                ...
                erbium_noc_axi_pkg::BURST_WRAP: begin
            ...
            if ((idqueue_id == t) && idqueue_valid) begin
              ...
              if (!slv_r_valid_tran[t] || (slv_r_valid_tran[t] && slv_r_ready_tran[t])) begin
                ...
                if (mst_resp.r_valid) begin
                  ...
                  r_req_d.r.resp = erbium_noc_axi_pkg::resp_precedence(r_req_q.r.resp, mst_resp.r.resp);

                  case (r_req_d.ar.burst)
                    erbium_noc_axi_pkg::BURST_INCR: begin
                      r_req_d.ar.addr = aligned_addr(erbium_noc_axi_pkg::largest_addr_t'(r_req_q.ar.addr), r_req_q.ar.size) + (1 << r_req_q.ar.size);
                    end
                    erbium_noc_axi_pkg::BURST_FIXED: begin
                  ...
                  case (r_state_q)
                    ...
                    R_INCR_DOWNSIZE, R_SPLIT_INCR_DOWNSIZE: begin
                      ...
                      if (r_req_q.burst_len == 0 ||
                          (aligned_addr(erbium_noc_axi_pkg::largest_addr_t'(r_req_d.ar.addr), r_req_q.orig_ar_size) !=
                           aligned_addr(erbium_noc_axi_pkg::largest_addr_t'(r_req_q.ar.addr), r_req_q.orig_ar_size)   )) begin
                        r_req_d.r_valid = 1'b1;
                      end
                    end
                  endcase
  ...
  always_comb begin
    ...
    if (mst_resp.b_valid) begin
      ...
      w_req_d.burst_resp = erbium_noc_axi_pkg::resp_precedence(w_req_q.burst_resp, mst_resp.b.resp);
    end
      ...
      W_PASSTHROUGH, W_INCR_DOWNSIZE, W_SPLIT_INCR_DOWNSIZE: begin
        ...
        if (mst_resp.w_ready && mst_req.w_valid) begin
          ...
          case (w_req_d.aw.burst)
            erbium_noc_axi_pkg::BURST_INCR: begin
              w_req_d.aw.addr = aligned_addr(erbium_noc_axi_pkg::largest_addr_t'(w_req_q.aw.addr), w_req_q.aw.size) + (1 << w_req_q.aw.size);
            end
            erbium_noc_axi_pkg::BURST_FIXED: begin
          ...
          case (w_state_q)
            ...
            W_INCR_DOWNSIZE, W_SPLIT_INCR_DOWNSIZE: begin
              if (w_req_q.burst_len == 0 ||
                  (aligned_addr(erbium_noc_axi_pkg::largest_addr_t'(w_req_d.aw.addr), w_req_q.orig_aw_size) !=
                   aligned_addr(erbium_noc_axi_pkg::largest_addr_t'(w_req_q.aw.addr), w_req_q.orig_aw_size)   )) begin
                slv_resp_o.w_ready = 1'b1;
              end
            end
          endcase
    ...
    if (w_state_d == W_IDLE) begin
      ...
      w_req_d.aw_valid       = 1'b0                ;
      w_req_d.aw_throw_error = 1'b0                ;
      w_req_d.burst_resp     = erbium_noc_axi_pkg::RESP_EXOKAY;

      if (!forward_b_beat_full) begin
        if (slv_req_i.aw_valid && slv_req_i.aw.atop[erbium_noc_axi_pkg::ATOP_R_RESP]) begin // ATOP with an R response
            ...
            erbium_noc_axi_pkg::BURST_FIXED: begin
              ...
              if (slv_req_i.aw.len == '0) begin
                ...
                if (conv_ratio != 1) begin
                  ...
                  w_req_d.aw.len   = w_req_d.burst_len  ;
                  w_req_d.aw.size  = AxiMstPortMaxSize  ;
                  w_req_d.aw.burst = erbium_noc_axi_pkg::BURST_INCR;
                end
              end else begin
...
endmodule : erbium_noc_axi_dw_downsizer
