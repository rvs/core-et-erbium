...
module erbium_noc_axi_interleaved_xbar
import erbium_noc_cf_math_pkg::idx_width;
#(
  parameter erbium_noc_axi_pkg::xbar_cfg_t Cfg                                   = '0,
  ...
  parameter type rule_t                                               = erbium_noc_axi_pkg::xbar_rule_64_t,
  // don't overwrite
...
`endif
    ...
    erbium_noc_axi_err_slv #(
      ...
      .axi_req_t   ( slv_req_t              ),
      .axi_resp_t  ( slv_resp_t             ),
      .Resp        ( erbium_noc_axi_pkg::RESP_DECERR   ),
      .ATOPs       ( ATOPs                  ),
  ...
  `endif
  // pragma translate_on
endmodule : erbium_noc_axi_interleaved_xbar

`include "axi/assign.svh"
`include "axi/typedef.svh"

module erbium_noc_axi_interleaved_xbar_intf
import erbium_noc_cf_math_pkg::idx_width;
#(
  parameter erbium_noc_axi_pkg::xbar_cfg_t Cfg     = '0,
...
`endif
  ...
  input  logic                                                      rst_ni,
  input  logic                                                      test_i,
  erbium_noc_AXI_BUS.Slave                                                     slv_ports [Cfg.NoSlvPorts-1:0],
  erbium_noc_AXI_BUS.Master                                                    mst_ports [Cfg.NoMstPorts-1:0],
  input  rule_t [Cfg.NoAddrRules-1:0]                               addr_map_i,
  input  logic  [Cfg.NoSlvPorts-1:0]                                en_default_mst_port_i,
  input  logic                                                      interleaved_mode_ena_i,
`ifdef VCS
...
`endif
  ...
  erbium_noc_axi_interleaved_xbar #(
    .Cfg  (Cfg),
    .ATOPs          ( ATOPS         ),
...
endmodule : erbium_noc_axi_interleaved_xbar_intf
