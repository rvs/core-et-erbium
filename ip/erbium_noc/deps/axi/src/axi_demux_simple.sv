...
module erbium_noc_axi_demux_simple #(
  ...
  localparam int unsigned IdCounterWidth = erbium_noc_cf_math_pkg::idx_width(MaxTrans);
  ...
  if (NoMstPorts == 32'h1) begin : gen_no_demux
    ...
    always_comb begin
      ...
      if (lock_aw_valid_q) begin
        ...
        if (aw_ready) begin
          ...
          atop_inject     = slv_req_i.aw.atop[erbium_noc_axi_pkg::ATOP_R_RESP] & AtopSupport;
        end
      end else begin
        ...
        if (!aw_id_cnt_full && (w_open != {IdCounterWidth{1'b1}}) &&
            (!(ar_id_cnt_full && slv_req_i.aw.atop[erbium_noc_axi_pkg::ATOP_R_RESP]) ||
             !AtopSupport)) begin
    ...
    if (UniqueIds) begin : gen_unique_ids_aw
      ...
      erbium_noc_axi_demux_id_counters #(
    ...
    //  B Channel
    //--------------------------------------
    logic [erbium_noc_cf_math_pkg::idx_width(NoMstPorts)-1:0] b_idx;
    ...
    logic [erbium_noc_cf_math_pkg::idx_width(NoMstPorts)-1:0] r_idx;
