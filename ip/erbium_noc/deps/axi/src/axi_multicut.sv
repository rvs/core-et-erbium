...
module erbium_noc_axi_multicut #(
...
// interface wrapper
module erbium_noc_axi_multicut_intf #(
...
module erbium_noc_axi_lite_multicut_intf #(
  // The address width.
  ...
  erbium_noc_AXI_LITE.Master out
);
