...
module erbium_noc_axi_lite_xbar #(
...
module erbium_noc_axi_lite_xbar_intf #(
  parameter erbium_noc_axi_pkg::xbar_cfg_t Cfg = '0,
  parameter type rule_t             = erbium_noc_axi_pkg::xbar_rule_64_t
) (
  input  logic                                                    clk_i,
  input  logic                                                    rst_ni,
  input  logic                                                    test_i,
  erbium_noc_AXI_LITE.Slave                                                  slv_ports [Cfg.NoSlvPorts-1:0],
  erbium_noc_AXI_LITE.Master                                                 mst_ports [Cfg.NoMstPorts-1:0],
  input  rule_t [Cfg.NoAddrRules-1:0]                             addr_map_i,
  input  logic  [Cfg.NoSlvPorts-1:0]                              en_default_mst_port_i,
