...
module erbium_noc_axi_to_mem_interleaved #(
  ...
  erbium_noc_axi_pkg::atop_t [NumBanks-1:0]  r_mem_atop,   w_mem_atop;
...
endmodule : erbium_noc_axi_to_mem_interleaved

`include "axi/typedef.svh"
`include "axi/assign.svh"
/// AXI4+ATOP interface wrapper for `axi_to_mem_interleaved`
module erbium_noc_axi_to_mem_interleaved_intf #(
  /// AXI4+ATOP ID width
  ...
  parameter type mem_atop_t = erbium_noc_axi_pkg::atop_t,
  /// Dependent parameter, do not override. Memory data type.
  ...
  erbium_noc_axi_to_mem_interleaved #(
    .axi_req_t     ( axi_req_t      ),
    .axi_resp_t    ( axi_resp_t     ),
