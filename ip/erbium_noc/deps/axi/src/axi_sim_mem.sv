...
module erbium_noc_axi_sim_mem #(
  ...
  output erbium_noc_axi_pkg::len_t [NumPorts-1:0]       mon_w_beat_count_o,
  ...
  output erbium_noc_axi_pkg::len_t [NumPorts-1:0]       mon_r_beat_count_o,
  ...
  typedef struct packed {
    ...
    erbium_noc_axi_pkg::len_t        beat_count;
    logic                 last;
  } monitor_t;

  monitor_t [NumPorts-1:0] mon_w, mon_r;
  logic [7:0]     mem[addr_t];
  erbium_noc_axi_pkg::resp_t rerr[addr_t] = '{default: 2'b0}; // default: 'axi_pkg::RESP_OKAY'
  erbium_noc_axi_pkg::resp_t werr[addr_t] = '{default: 2'b0}; // default: 'axi_pkg::RESP_OKAY'
  ...
  erbium_noc_axi_pkg::resp_t [NumPorts-1:0] error_happened = erbium_noc_axi_pkg::RESP_OKAY;
      ...
      fork
        ...
        forever begin
          ...
          if (aw_queue.size() != 0) begin
            ...
            if (axi_req_i[i].w_valid) begin
              automatic erbium_noc_axi_pkg::burst_t burst = aw_queue[0].burst;
              automatic erbium_noc_axi_pkg::len_t len = aw_queue[0].len;
              automatic erbium_noc_axi_pkg::size_t size = aw_queue[0].size;
              automatic addr_t addr = erbium_noc_axi_pkg::beat_addr(aw_queue[0].addr, size, len, burst,
                  w_cnt);
              mon_w[i].valid = 1'b1;
              mon_w[i].addr = addr;
              ...
              for (shortint unsigned
                  i_byte = erbium_noc_axi_pkg::beat_lower_byte(aw_queue[0].addr, size, len, burst, StrbWidth, w_cnt);
                  i_byte <= erbium_noc_axi_pkg::beat_upper_byte(aw_queue[0].addr, size, len, burst, StrbWidth, w_cnt);
                  i_byte++) begin
                if (axi_req_i[i].w.strb[i_byte]) begin
                  automatic addr_t byte_addr = (addr / StrbWidth) * StrbWidth + i_byte;
                  mem[byte_addr] = axi_req_i[i].w.data[i_byte*8+:8];
                  error_happened[i] = erbium_noc_axi_pkg::resp_precedence(werr[byte_addr], error_happened[i]);
                  if (ClearErrOnAccess)
                    werr[byte_addr] = erbium_noc_axi_pkg::RESP_OKAY;
                end
              end
              if (w_cnt == aw_queue[0].len) begin
                ...
                w_cnt = 0;
                mon_w[i].last = 1'b1;
                error_happened[i] = erbium_noc_axi_pkg::RESP_OKAY;
        ...
        forever begin
          ...
          if (ar_queue.size() != 0) begin
            automatic erbium_noc_axi_pkg::burst_t burst = ar_queue[0].burst;
            automatic erbium_noc_axi_pkg::len_t len = ar_queue[0].len;
            automatic erbium_noc_axi_pkg::size_t size = ar_queue[0].size;
            automatic addr_t addr = erbium_noc_axi_pkg::beat_addr(ar_queue[0].addr, size, len, burst, r_cnt);
            automatic r_t r_beat = '0;
            automatic data_t r_data = 'x; // compatibility reasons
            r_beat.data = 'x;
            r_beat.id = ar_queue[0].id;
            r_beat.resp = erbium_noc_axi_pkg::RESP_OKAY;
            r_beat.user = ar_queue[0].user;
            for (shortint unsigned
                i_byte = erbium_noc_axi_pkg::beat_lower_byte(ar_queue[0].addr, size, len, burst, StrbWidth, r_cnt);
                i_byte <= erbium_noc_axi_pkg::beat_upper_byte(ar_queue[0].addr, size, len, burst, StrbWidth, r_cnt);
                i_byte++) begin
              automatic addr_t byte_addr = (addr / StrbWidth) * StrbWidth + i_byte;
              ...
              r_beat.resp = erbium_noc_axi_pkg::resp_precedence(rerr[byte_addr], r_beat.resp);
              if (ClearErrOnAccess & axi_req_i[i].r_ready) begin
                rerr[byte_addr] = erbium_noc_axi_pkg::RESP_OKAY;
              end
            end
            r_beat.data = r_data;
...
module erbium_noc_axi_sim_mem_intf #(
  ...
  input  logic                      clk_i,
  input  logic                      rst_ni,
  erbium_noc_AXI_BUS.Slave                     axi_slv,
  ...
  output erbium_noc_axi_pkg::len_t             mon_w_beat_count_o,
  ...
  output erbium_noc_axi_pkg::len_t             mon_r_beat_count_o,
...
///
/// See the documentation of the main module for the definition of ports and parameters.
module erbium_noc_axi_sim_mem_multiport_intf #(
  parameter int unsigned AXI_ADDR_WIDTH = 32'd0,
  parameter int unsigned AXI_DATA_WIDTH = 32'd0,
  parameter int unsigned AXI_ID_WIDTH = 32'd0,
  parameter int unsigned AXI_USER_WIDTH = 32'd0,
  ...
  input  logic                      clk_i,
  input  logic                      rst_ni,
  erbium_noc_AXI_BUS.Slave                     axi_slv[NUM_PORTS],
  ...
  output erbium_noc_axi_pkg::len_t [NUM_PORTS-1:0]            mon_w_beat_count_o,
  ...
  output erbium_noc_axi_pkg::len_t [NUM_PORTS-1:0]            mon_r_beat_count_o,
