...
module erbium_noc_axi_lite_from_mem #(
  ...
  parameter erbium_noc_axi_pkg::prot_t AxiProt = 3'b000,
  ...
  assign mem_rsp_error_o = rsp_sel ?
      (axi_rsp_i.b.resp inside {erbium_noc_axi_pkg::RESP_SLVERR, erbium_noc_axi_pkg::RESP_DECERR}) :
      (axi_rsp_i.r.resp inside {erbium_noc_axi_pkg::RESP_SLVERR, erbium_noc_axi_pkg::RESP_DECERR});
