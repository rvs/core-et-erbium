...
module erbium_noc_axi_to_mem_split #(
  ...
  output erbium_noc_axi_pkg::atop_t [NumMemPorts-1:0] mem_atop_o,   // atomic operation
...
module erbium_noc_axi_to_mem_split_intf #(
  /// AXI4+ATOP ID width
  ...
  erbium_noc_AXI_BUS.Slave                              axi_bus,
  ...
  output erbium_noc_axi_pkg::atop_t [NUM_MEM_PORTS-1:0] mem_atop_o,
