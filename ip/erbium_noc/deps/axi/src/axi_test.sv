...
package erbium_noc_axi_test;

  import erbium_noc_axi_pkg::*;
  ...
  class axi_lite_driver #(
    ...
    virtual erbium_noc_AXI_LITE_DV #(
      .AXI_ADDR_WIDTH(AW),
      .AXI_DATA_WIDTH(DW)
    ) axi;
    ...
    task send_b (
      input erbium_noc_axi_pkg::resp_t resp
    );
      axi.b_resp  <= #TA resp;
      axi.b_valid <= #TA 1;
      cycle_start();
    ...
    task recv_b (
      output erbium_noc_axi_pkg::resp_t resp
    );
      axi.b_ready <= #TA 1;
      cycle_start();
  ...
  class axi_b_beat #(
    ...
    erbium_noc_axi_pkg::resp_t     b_resp = '0;
  ...
  class axi_r_beat #(
    ...
    erbium_noc_axi_pkg::resp_t     r_resp = '0;
    logic               r_last = '0;
  ...
  class axi_rand_master #(
    ...
    typedef erbium_noc_axi_test::axi_driver #(
      .AW(AW), .DW(DW), .IW(IW), .UW(UW), .TA(TA), .TT(TT)
    ) axi_driver_t;
    typedef logic [AW-1:0]      addr_t;
    typedef erbium_noc_axi_pkg::burst_t    burst_t;
    typedef erbium_noc_axi_pkg::cache_t    cache_t;
    typedef logic [DW-1:0]      data_t;
    typedef logic [IW-1:0]      id_t;
    typedef erbium_noc_axi_pkg::len_t      len_t;
    typedef erbium_noc_axi_pkg::size_t     size_t;
    typedef logic [UW-1:0]      user_t;
    typedef erbium_noc_axi_pkg::mem_type_t mem_type_t;
    ...
    function ax_beat_t new_rand_burst(input logic is_read, input user_t user);
      ...
      if (mem_map.size() == 0) begin
        ...
        mem_region = '{
          addr_begin: '0,
          addr_end:   '1,
          mem_type:   erbium_noc_axi_pkg::NORMAL_NONCACHEABLE_BUFFERABLE
        };
      end else begin
      ...
      ax_beat.ax_cache = is_read ? erbium_noc_axi_pkg::get_arcache(mem_region.mem_type) : erbium_noc_axi_pkg::get_awcache(mem_region.mem_type);
      // Randomize beat size.
      if (TRAFFIC_SHAPING) begin
        ...
        forever begin
          ...
          if (erbium_noc_axi_pkg::beat_addr(addr, ax_beat.ax_size, ax_beat.ax_len, ax_beat.ax_burst, 0) >> 12 ==
              erbium_noc_axi_pkg::beat_addr(addr, ax_beat.ax_size, ax_beat.ax_len, ax_beat.ax_burst, ax_beat.ax_len) >> 12) begin
            break;
          end
        end
      end else begin
      ...
      ax_beat.ax_addr =  erbium_noc_axi_pkg::aligned_addr(addr, erbium_noc_axi_pkg::size_t'(SIZE_ALIGN) );
    ...
    task rand_atop_burst(inout ax_beat_t beat, input user_t user);
      ...
      forever begin
        ...
        if (beat.ax_atop[5:4] != 2'b00) begin // ATOP
          // Determine `ax_atop`.
          if (beat.ax_atop[5:4] == erbium_noc_axi_pkg::ATOP_ATOMICSTORE ||
              beat.ax_atop[5:4] == erbium_noc_axi_pkg::ATOP_ATOMICLOAD) begin
            // Endianness
          ...
          if (2**beat.ax_size < AXI_STRB_WIDTH) begin
            ...
            if (beat.ax_atop == erbium_noc_axi_pkg::ATOP_ATOMICCMP) begin
          ...
          if (beat.ax_atop == erbium_noc_axi_pkg::ATOP_ATOMICCMP) begin
            ...
            beat.ax_burst = (beat.ax_addr % ((beat.ax_len+1) * 2**beat.ax_size) == 0) ?
                erbium_noc_axi_pkg::BURST_INCR : erbium_noc_axi_pkg::BURST_WRAP;
            // If we are not allowed to emit WRAP bursts, align the address to the total size of
            // outgoing data and fall back to INCR.
            if (beat.ax_burst == erbium_noc_axi_pkg::BURST_WRAP && !AXI_BURST_WRAP) begin
              beat.ax_addr -= (beat.ax_addr % ((beat.ax_len+1) * 2**beat.ax_size));
              beat.ax_burst = erbium_noc_axi_pkg::BURST_INCR;
            end
          end else begin
          ...
          if (erbium_noc_axi_pkg::beat_addr(beat.ax_addr, beat.ax_size, beat.ax_len, beat.ax_burst, 0) >> 12 ==
              erbium_noc_axi_pkg::beat_addr(beat.ax_addr, beat.ax_size, beat.ax_len, beat.ax_burst, beat.ax_len) >> 12) begin
            break;
          end else begin
    ...
    function void rand_excl_ar(inout ax_beat_t ar_beat, input user_t user);
      forever begin
        ...
        // Make sure that the burst does not cross a 4KiB boundary.
        if (erbium_noc_axi_pkg::beat_addr(ar_beat.ax_addr, ar_beat.ax_size, ar_beat.ax_len, ar_beat.ax_burst, 0) >> 12 ==
            erbium_noc_axi_pkg::beat_addr(ar_beat.ax_addr, ar_beat.ax_size, ar_beat.ax_len, ar_beat.ax_burst, ar_beat.ax_len) >> 12) begin
          break;
        end else begin
    ...
    task legalize_id(input bit is_read, inout ax_beat_t beat);
      ...
      if (!is_read) begin
        ...
        if (beat.ax_atop != 2'b00) begin
          ...
          if (beat.ax_atop[erbium_noc_axi_pkg::ATOP_R_RESP]) begin
    ...
    task send_ws(ref logic aw_done);
      while (!(aw_done && w_queue.size() == 0)) begin
        ...
        for (int unsigned i = 0; i < aw_beat.ax_len + 1; i++) begin
          ...
          addr = erbium_noc_axi_pkg::beat_addr(aw_beat.ax_addr, aw_beat.ax_size, aw_beat.ax_len,
                                    aw_beat.ax_burst, i);
`ifdef XSIM
  ...
  class axi_rand_slave #(
    ...
    task recv_ars();
      forever begin
        ...
        drv.recv_ar(ar_beat);
        if (MAPPED) begin
          assert (ar_beat.ax_burst != erbium_noc_axi_pkg::BURST_WRAP) else
    ...
    task send_rs();
      forever begin
        ...
        byte_addr    = erbium_noc_axi_pkg::aligned_addr(ar_beat.ax_addr, erbium_noc_axi_pkg::size_t'($clog2(DW/8)));
`ifdef XSIM
...
`endif
        if (MAPPED) begin
          ...
          r_beat.r_resp = erbium_noc_axi_pkg::RESP_OKAY;
        end
        r_beat.r_id = ar_beat.ax_id;
        if (RAND_RESP && !ar_beat.ax_atop[erbium_noc_axi_pkg::ATOP_R_RESP])
        ...
        if (ar_beat.ax_len == '0) begin
          ...
          if ((ar_beat.ax_burst == erbium_noc_axi_pkg::BURST_INCR) && MAPPED) begin
            ar_beat.ax_addr = erbium_noc_axi_pkg::aligned_addr(ar_beat.ax_addr, ar_beat.ax_size) +
                                  2**ar_beat.ax_size;
          end
          ar_beat.ax_len--;
    ...
    task recv_aws();
      forever begin
        ...
        if (MAPPED) begin
          ...
          assert (aw_beat.ax_burst != erbium_noc_axi_pkg::BURST_WRAP) else
            $error("axi_pkg::BURST_WRAP not supported in MAPPED mode.");
        end
        aw_queue.push_back(aw_beat);
        // Atomic{Load,Swap,Compare}s require an R response.
        if (aw_beat.ax_atop[erbium_noc_axi_pkg::ATOP_R_RESP]) begin
      ...
      forever begin
        ...
        forever begin
          ...
          if (MAPPED) begin
            ...
            aw_beat = aw_queue[0];
            byte_addr    = erbium_noc_axi_pkg::aligned_addr(aw_beat.ax_addr, $clog2(DW/8));
            ...
            if (aw_beat.ax_burst == erbium_noc_axi_pkg::BURST_INCR) begin
              aw_beat.ax_addr = erbium_noc_axi_pkg::aligned_addr(aw_beat.ax_addr, aw_beat.ax_size) +
                                    2**aw_beat.ax_size;
            end
            aw_queue[0] = aw_beat;
          end
...
`endif
        ...
        if (RAND_RESP && !aw_beat.ax_atop[erbium_noc_axi_pkg::ATOP_R_RESP])
        ...
        rand_wait(RESP_MIN_WAIT_CYCLES, RESP_MAX_WAIT_CYCLES);
        if (MAPPED) begin
          b_beat.b_resp = erbium_noc_axi_pkg::RESP_OKAY;
        end
        drv.send_b(b_beat);
        b_wait_cnt--;
      end
  ...
  class axi_lite_rand_master #(
    ...
    typedef erbium_noc_axi_test::axi_lite_driver #(
    ...
    task automatic recv_rs(input int unsigned n_reads);
      ...
      automatic erbium_noc_axi_pkg::resp_t  r_resp;
      repeat (n_reads) begin
        wait (ar_queue.size() > 0);
    ...
    task automatic recv_bs(input int unsigned n_writes);
      ...
      automatic erbium_noc_axi_pkg::resp_t b_resp;
      repeat (n_writes) begin
    ...
    task automatic write(input addr_t w_addr, input prot_t w_prot = prot_t'(0), input data_t w_data,
                         input strb_t w_strb, output erbium_noc_axi_pkg::resp_t b_resp);
    ...
    task automatic erbium_noc_read(input addr_t r_addr, input prot_t r_prot = prot_t'(0),
                        output data_t r_data, output erbium_noc_axi_pkg::resp_t r_resp);
  ...
  class axi_scoreboard #(
    ...
    localparam erbium_noc_axi_pkg::size_t BUS_SIZE = $clog2(DW/8);
    ...
    protected task automatic handle_write();
      ...
      forever begin
        ...
        assert (aw_beat.ax_burst == erbium_noc_axi_pkg::BURST_INCR || aw_beat.ax_len == '0) else
        ...
        for (int unsigned i = 0; i <= aw_beat.ax_len; i++) begin
          beat_addresses[i] = erbium_noc_axi_pkg::beat_addr(aw_beat.ax_addr, aw_beat.ax_size, aw_beat.ax_len,
              aw_beat.ax_burst, i);
          bus_address       = erbium_noc_axi_pkg::aligned_addr(beat_addresses[i], BUS_SIZE);
          // Check if the memory array is initialyzed at this beat address (aligned on the bus)
          if (!this.memory_q.exists(bus_address)) begin
            for (int unsigned j = 0; j < erbium_noc_axi_pkg::num_bytes(BUS_SIZE); j++) begin
    ...
    protected task automatic handle_write_resp(input axi_id_t id);
      ...
      forever begin
        ...
        for (int unsigned i = 0; i <= aw_beat.ax_len; i++) begin
          bus_address = erbium_noc_axi_pkg::aligned_addr(
              erbium_noc_axi_pkg::beat_addr(aw_beat.ax_addr, aw_beat.ax_size, aw_beat.ax_len, aw_beat.ax_burst,
                  i), BUS_SIZE);
          for (int j = 0; j < erbium_noc_axi_pkg::num_bytes(BUS_SIZE); j++) begin
            if (b_beat.b_resp inside {erbium_noc_axi_pkg::RESP_OKAY, erbium_noc_axi_pkg::RESP_EXOKAY}) begin
    ...
    protected task automatic handle_read(input axi_id_t id);
      ...
      forever begin
        ...
        // This scoreborad only supports this type of burst:
        assert (ar_beat.ax_burst == erbium_noc_axi_pkg::BURST_INCR || ar_beat.ax_len == '0) else
            $warning("Not supported AR burst: BURST: %0h.", ar_beat.ax_burst);

        for (int unsigned i = 0; i <= ar_beat.ax_len; i++) begin
          wait (this.r_sample[id].size() > 0);
          r_beat = this.r_sample[id].pop_front();
          beat_address = erbium_noc_axi_pkg::beat_addr(ar_beat.ax_addr, ar_beat.ax_size, ar_beat.ax_len,
              ar_beat.ax_burst, i);
          beat_address = erbium_noc_axi_pkg::aligned_addr(beat_address, ar_beat.ax_size);
          bus_address  = erbium_noc_axi_pkg::aligned_addr(beat_address, BUS_SIZE);
          if(i!=0)
          ...
          if (this.check_en[ReadCheck] &&
              (r_beat.r_resp inside {erbium_noc_axi_pkg::RESP_OKAY, erbium_noc_axi_pkg::RESP_EXOKAY})) begin
            for (int unsigned j = first_byte_to_check; j < erbium_noc_axi_pkg::num_bytes(ar_beat.ax_size); j++) begin
...
module erbium_noc_axi_chan_logger #(
  ...
  always @(posedge clk_i) #TestTime begin : proc_channel_sample
    ...
    if (rst_ni) begin
      ...
      if (aw_valid_i && aw_ready_i) begin
        ...
        if (aw_chan_i.atop[erbium_noc_axi_pkg::ATOP_R_RESP]) begin
