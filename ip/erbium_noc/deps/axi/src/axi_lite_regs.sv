...
/// respectively.
module erbium_noc_axi_lite_regs #(
  ...
  localparam int unsigned NumChunks     = erbium_noc_cf_math_pkg::ceil_div(RegNumBytes, AxiStrbWidth);
  ...
  always_comb begin
    ...
    // Response
    b_chan              = b_chan_lite_t'{resp: erbium_noc_axi_pkg::RESP_SLVERR, default: '0};
    b_valid             = 1'b0;
    // write active flag
    wr_active_o         = '0;
    ...
    if (axi_req_i.aw_valid && axi_req_i.w_valid && b_ready) begin
      ...
      if (aw_dec_valid && aw_prot_ok) begin
        ...
        if (!chunk_loaded) begin
          ...
          b_chan.resp         = chunk_ro ? erbium_noc_axi_pkg::RESP_SLVERR : erbium_noc_axi_pkg::RESP_OKAY;
          b_valid             = 1'b1;
  ...
  always_comb begin
    ...
    if (ar_dec_valid && ar_prot_ok) begin
      ...
      r_chan.resp = erbium_noc_axi_pkg::RESP_OKAY;
    end
  end
...
module erbium_noc_axi_lite_regs_intf #(
  parameter type byte_t = logic [7:0],
