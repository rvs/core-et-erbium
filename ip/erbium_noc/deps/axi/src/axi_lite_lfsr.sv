...
module erbium_noc_axi_lite_lfsr #(
    ...
    assign rsp_o.b.resp  = erbium_noc_axi_pkg::RESP_OKAY;
    ...
    assign rsp_o.r.resp  = erbium_noc_axi_pkg::RESP_OKAY;
    assign r_lfsr_en     = req_i.r_ready & rsp_o.r_valid;
    assign rsp_o.r_valid = !r_ser_en_i;

endmodule : erbium_noc_axi_lite_lfsr
...
module erbium_noc_axi_opt_lfsr #(
    ...
    localparam int unsigned LfsrIdxWidth = erbium_noc_cf_math_pkg::idx_width(Width);
...
endmodule : erbium_noc_axi_opt_lfsr
