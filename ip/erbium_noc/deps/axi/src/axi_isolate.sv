...
module erbium_noc_axi_isolate_inner #(
  parameter int unsigned NumPending = 32'd16,
  parameter type         axi_req_t  = logic,
  parameter type         axi_resp_t = logic
) (
  ...
  always_comb begin
    ...
    if (mst_req_o.aw_valid && (state_aw_q == Normal)) begin
      ...
      update_w_cnt    = 1'b1;
      connect_w       = 1'b1;
      if (mst_req_o.aw.atop[erbium_noc_axi_pkg::ATOP_R_RESP]) begin
...
module erbium_noc_axi_isolate_intf #(
