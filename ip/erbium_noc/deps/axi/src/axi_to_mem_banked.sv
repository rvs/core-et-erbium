...
module erbium_noc_axi_to_mem_banked #(
  /// AXI4+ATOP ID width
  ...
  localparam int unsigned BankSelWidth  = erbium_noc_cf_math_pkg::idx_width(MemNumBanks);
...
module erbium_noc_axi_to_mem_banked_intf #(
  /// AXI4+ATOP ID width
