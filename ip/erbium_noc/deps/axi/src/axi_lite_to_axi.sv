...
module erbium_noc_axi_lite_to_axi #(
  ...
  input  erbium_noc_axi_pkg::cache_t slv_aw_cache_i,
  input  erbium_noc_axi_pkg::cache_t slv_ar_cache_i,
  // Master AXI port
  output axi_req_t        mst_req_o,
  input  axi_resp_t       mst_resp_i
);
  localparam int unsigned AxiSize = erbium_noc_axi_pkg::size_t'($unsigned($clog2(AxiDataWidth/8)));
  ...
  assign mst_req_o = '{
    aw: '{
      ...
      size:  AxiSize,
      burst: erbium_noc_axi_pkg::BURST_FIXED,
...
module erbium_noc_axi_lite_to_axi_intf #(
  parameter int unsigned AXI_DATA_WIDTH = 32'd0
) (
  erbium_noc_AXI_LITE.Slave  in,
  input erbium_noc_axi_pkg::cache_t slv_aw_cache_i,
  input erbium_noc_axi_pkg::cache_t slv_ar_cache_i,
  erbium_noc_AXI_BUS.Master  out
);
  localparam int unsigned AxiSize = erbium_noc_axi_pkg::size_t'($unsigned($clog2(AXI_DATA_WIDTH/8)));
...
// pragma translate_on
  ...
  assign out.aw_len    = '0;
  assign out.aw_size   = erbium_noc_axi_pkg::size_t'(AxiSize);
  assign out.aw_burst  = erbium_noc_axi_pkg::BURST_FIXED;
  ...
  assign out.ar_len    = '0;
  assign out.ar_size   = erbium_noc_axi_pkg::size_t'(AxiSize);
  assign out.ar_burst  = erbium_noc_axi_pkg::BURST_FIXED;
