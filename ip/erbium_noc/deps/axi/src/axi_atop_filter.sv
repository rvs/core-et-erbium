...
module erbium_noc_axi_atop_filter #(
  /// AXI ID width
    ...
    unique case (w_state_q)
      ...
      W_FEEDTHROUGH: begin
        ...
        if (aw_without_complete_w_downstream // .. downstream is missing W bursts ..
            ...
            || ((slv_req_i.aw_valid && slv_req_i.aw.atop[5:4] == erbium_noc_axi_pkg::ATOP_NONE)
                && !complete_w_without_aw_downstream)
        ) begin
        ...
        if (slv_req_i.aw_valid && slv_req_i.aw.atop[5:4] != erbium_noc_axi_pkg::ATOP_NONE) begin
          mst_req_o.aw_valid  = 1'b0; // Do not let AW pass to master port.
          slv_resp_o.aw_ready = 1'b1; // Absorb AW on slave port.
          id_d = slv_req_i.aw.id; // Store ID for B response.
          // Some atomic operations require a response on the R channel.
          if (slv_req_i.aw.atop[erbium_noc_axi_pkg::ATOP_R_RESP]) begin
      ...
      INJECT_B: begin
        ...
        slv_resp_o.b.resp = erbium_noc_axi_pkg::RESP_SLVERR;
  ...
  always_comb begin
    ...
    unique case (r_state_q)
      ...
      INJECT_R: begin
        ...
        slv_resp_o.r.resp  = erbium_noc_axi_pkg::RESP_SLVERR;
...
module erbium_noc_axi_atop_filter_intf #(
  /// AXI ID width
