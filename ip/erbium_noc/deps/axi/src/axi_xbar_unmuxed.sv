...
module erbium_noc_axi_xbar_unmuxed
...
module erbium_noc_axi_xbar_unmuxed_intf
import erbium_noc_cf_math_pkg::idx_width;
#(
  ...
  erbium_noc_AXI_BUS.Master                                                    mst_ports [Cfg.NoMstPorts-1:0][Cfg.NoSlvPorts-1:0],
  input  rule_t [Cfg.NoAddrRules-1:0]                               addr_map_i,
  input  logic  [Cfg.NoSlvPorts-1:0]                                en_default_mst_port_i,
