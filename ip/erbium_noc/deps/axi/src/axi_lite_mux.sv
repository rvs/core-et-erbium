...
module erbium_noc_axi_lite_mux #(
...
module erbium_noc_axi_lite_mux_intf #(
  ...
  erbium_noc_AXI_LITE.Slave  slv [NoSlvPorts-1:0], // slave ports
  erbium_noc_AXI_LITE.Master mst                   // master port
);
