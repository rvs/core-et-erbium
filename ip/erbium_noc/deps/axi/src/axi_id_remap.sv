...
module erbium_noc_axi_id_remap #(
  ...
  localparam int unsigned IdxWidth = erbium_noc_cf_math_pkg::idx_width(AxiSlvPortMaxUniqIds);
...
module erbium_noc_axi_id_remap_table #(
  ...
  /// `MaxUniqInpIds`).
  localparam int unsigned IdxWidth = erbium_noc_cf_math_pkg::idx_width(MaxUniqInpIds),
...
module erbium_noc_axi_id_remap_intf #(
