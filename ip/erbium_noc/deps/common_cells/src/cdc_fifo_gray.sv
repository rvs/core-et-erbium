...
module erbium_noc_cdc_fifo_gray #(
...
(* no_ungroup *)
(* no_boundary_optimization *)
module erbium_noc_cdc_fifo_gray_src #(
...
(* no_ungroup *)
(* no_boundary_optimization *)
module erbium_noc_cdc_fifo_gray_dst #(
  parameter type T = logic,
  parameter int LOG_DEPTH = 3,
  parameter int SYNC_STAGES = 2
)(
