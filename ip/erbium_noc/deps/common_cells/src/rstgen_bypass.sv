...
module erbium_noc_rstgen_bypass #(
    ...
    erbium_noc_tc_clk_mux2 i_tc_clk_mux2_rst_n (
        .clk0_i     ( rst_ni ),
    ...
    erbium_noc_tc_clk_mux2 i_tc_clk_mux2_rst_no (
    ...
    erbium_noc_tc_clk_mux2 i_tc_clk_mux2_init_no (
        .clk0_i     ( synch_regs_q[NumRegs-1] ),
        .clk1_i     ( 1'b1 ),
        .clk_sel_i  ( test_mode_i ),
        .clk_o      ( init_no )
