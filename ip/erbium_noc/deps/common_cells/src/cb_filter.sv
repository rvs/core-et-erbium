...
module erbium_noc_cb_filter #(
  ...
  parameter erbium_noc_cb_filter_pkg::cb_seed_t [KHashes-1:0] Seeds = erbium_noc_cb_filter_pkg::EgSeeds
) (
...
module erbium_noc_hash_block #(
  ...
  parameter erbium_noc_cb_filter_pkg::cb_seed_t [NoHashes-1:0] Seeds = erbium_noc_cb_filter_pkg::EgSeeds
) (
