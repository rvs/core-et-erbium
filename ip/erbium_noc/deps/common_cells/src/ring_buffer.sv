...
module erbium_noc_ring_buffer #(
    parameter int unsigned Depth = 32,
    parameter type data_t = logic,
    /// Derived parameter *Do not override*
    localparam int unsigned AddrWidth = erbium_noc_cf_math_pkg::idx_width(Depth),
    localparam int unsigned StepWidth = erbium_noc_cf_math_pkg::idx_width(Depth+1),
    ...
    `ASSERT_INIT(CheckDepthPow2, erbium_noc_cf_math_pkg::is_power_of_2(Depth))
