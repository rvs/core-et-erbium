...
module erbium_noc_cdc_reset_ctrlr
  import erbium_noc_cdc_reset_ctrlr_pkg::*;
 #(
  ...
  erbium_noc_cdc_reset_ctrlr_half #(
...
module erbium_noc_cdc_reset_ctrlr_half
  import erbium_noc_cdc_reset_ctrlr_pkg::*;
#(
  /// The number of synchronization stages to use for the
...
endmodule : erbium_noc_cdc_reset_ctrlr_half
