...
module erbium_noc_id_queue #(
    ...
    localparam int unsigned HtIdxWidth = erbium_noc_cf_math_pkg::idx_width(HtCapacity);
    localparam int unsigned LdIdxWidth = erbium_noc_cf_math_pkg::idx_width(CAPACITY);
