...
module erbium_noc_cdc_2phase_clearable #(
  ...
  erbium_noc_cdc_2phase_src_clearable #(
    .T           ( T           ),
  ...
  erbium_noc_cdc_2phase_dst_clearable #(
    .T           ( T           ),
    .SYNC_STAGES ( SYNC_STAGES )
  ) i_dst (
    .rst_ni       ( dst_rst_ni                       ),
...
module erbium_noc_cdc_2phase_src_clearable #(
  parameter type T = logic,
...
/// domain.
module erbium_noc_cdc_2phase_dst_clearable #(
  parameter type T = logic,
  parameter int unsigned SYNC_STAGES = 2
)(
  input  logic rst_ni,
